...
export function OfferDetail() {
  ...
  const handleSubmitApplication = async () => {
    ...
    if (!applicationForm.cvFile) {
      setApplicationErrors({ cvFile: "Un CV est requis pour postuler." });
      setToast({
        type: "error",
        message: "Un CV est requis pour postuler.",
      });
      setSubmittingApplication(false);
      return;
    }
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (file) {
                      setApplicationErrors((prev) => ({ ...prev, cvFile: "" }));
                    }
                  }}
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  ...
                  disabled={submittingApplication || !applicationForm.cvFile}
